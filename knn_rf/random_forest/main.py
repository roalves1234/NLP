...
from funcoes import preprocess_text, get_bert_embeddings, get_device
...
# Removendo expandable_segments que não é suportado nesta plataforma
...
# Usar class_weight para lidar com o desbalanceamento de classes
...
with tqdm(total=100, desc="Treinando o modelo") as pbar:
    # O RandomForestClassifier não suporta callbacks para progresso,
    # então vamos usar um truque: simular o progresso durante o treino
    # baseado no tempo estimado
    classifier.fit(X_train_embeddings, y_train)
    pbar.update(100)  # Completa a barra ao finalizar
