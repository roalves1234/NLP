...
MODEL_OUTPUT = "modelo_completo.pkl"
...
def main():
    ...
    # Treinar o modelo com os embeddings gerados
    print(f"\n> Iniciando treinamento com {len(embedding_files)} arquivos de embeddings")
    classifier, report = train_incremental_model(
        embedding_files,
